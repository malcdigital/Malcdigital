 ...
 * @property {string} colour   hint for the room renderer
 */

/** @type {Record<string, Material>} */
export const MATERIALS = {
  stone:        { name: 'Cut stone',         alpha: [0.02, 0.02, 0.03, 0.03, 0.04, 0.05], colour: '#8d8b84' },
  brick:        { name: 'Bare brick',        alpha: [0.03, 0.03, 0.03, 0.04, 0.05, 0.07], colour: '#8f6f5e' },
  plaster:      { name: 'Plaster',           alpha: [0.14, 0.10, 0.06, 0.05, 0.04, 0.03], colour: '#c8c2b6' },
  drywall:      { name: 'Plasterboard',      alpha: [0.29, 0.10, 0.05, 0.04, 0.07, 0.09], colour: '#cfcabf' },
  woodPanel:    { name: 'Wood panelling',    alpha: [0.28, 0.22, 0.17, 0.09, 0.10, 0.11], colour: '#a0724a' },
  woodFloor:    { name: 'Wood floor',        alpha: [0.15, 0.11, 0.10, 0.07, 0.06, 0.07], colour: '#96693f' },
  marble:       { name: 'Marble floor',      alpha: [0.01, 0.01, 0.01, 0.01, 0.02, 0.02], colour: '#b9b5ad' },
  carpet:       { name: 'Carpet',            alpha: [0.02, 0.06, 0.14, 0.37, 0.60, 0.65], colour: '#5c5148' },
  glass:        { name: 'Glazing',           alpha: [0.35, 0.25, 0.18, 0.12, 0.07, 0.04], colour: '#7fa6b5' },
  seatsEmpty:   { name: 'Empty seating',     alpha: [0.19, 0.37, 0.56, 0.67, 0.61, 0.59], colour: '#6b3f46' },
  seatsFull:    { name: 'Occupied seating',  alpha: [0.39, 0.57, 0.80, 0.94, 0.92, 0.87], colour: '#7a4a52' },
  pews:         { name: 'Wooden pews',       alpha: [0.10, 0.09, 0.08, 0.12, 0.14, 0.16], colour: '#7b5a3a' },
};

/** Treatment the user can hang on the walls, in increasing broadband strength. */
export const TREATMENTS = {
  foam:      { name: 'Foam tiles',      alpha: [0.10, 0.30, 0.70, 0.90, 0.95, 0.95], colour: '#3f4a5c',
               blurb: 'Kills highs, leaves the low end alone.' },
  rockwool:  { name: 'Rockwool + traps', alpha: [0.45, 0.75, 0.95, 0.98, 0.95, 0.90], colour: '#4a5a48',
               blurb: 'Broadband. Takes the bass down with everything else.' },
  drapes:    { name: 'Heavy drapes',    alpha: [0.14, 0.35, 0.55, 0.72, 0.70, 0.65], colour: '#5b3a52',
               blurb: 'Soft mid/high damping, keeps some air.' },
  diffusion: { name: 'Diffusers',       alpha: [0.10, 0.15, 0.20, 0.22, 0.20, 0.18], colour: '#55503f',
